...
if cameraFeed: intialTracbarVals = [24,55,12,100]
else: intialTracbarVals = [ 42,63,14,87]
...
while True:
    ...
    try:
        ...
        cv2.putText(imgFinal, str(int(averageCurve)), (frameWidth//2-70, 70), cv2.FONT_HERSHEY_COMPLEX, 1.75, (0,0,255), 2, cv2.LINE_AA)
    except:
        lane_curve = 00
        pass
